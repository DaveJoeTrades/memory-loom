  ...
  return (
    <div>
      <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 8, flexWrap: "wrap" }}>
        <Btn small variant="ghost" onClick={() => setZoom(z => Math.max(0.6, +(z - 0.2).toFixed(2)))}>{"\u2212"}</Btn>
      ...
      <div style={{ overflow: "auto", WebkitOverflowScrolling: "touch", border: `1px solid ${T.line}`, borderRadius: 12, background: T.paper, maxHeight: "70vh", cursor: "grab" }}>
